      ...
      { lease && (
        ...
        <Grid container sx={{marginLeft:1, marginTop: 1}}>
          <Grid item xs={12} sx={{ marginBottom: 2 }}>
            Kontraktsnummer <b>{ lease.leaseId }</b><br/>
            Lantmäteriets lägenhetsnummer <b>{ lease.apartment?.apartmentNumber }</b><br/>
          </Grid>
          <Grid item xs={4}>
            Adress
          </Grid>
          <Grid item xs={8}>
            <b>{ lease.apartment?.address?.street + ' ' + lease.apartment?.address?.number }</b>
          </Grid>
          <Grid item xs={4}>
            Typ
          </Grid>
          ...
          <Grid item xs={12} sx={{ marginTop: 2, marginBottom: 2, marginRight: 3 }}>
        ...
        <Grid container sx={{marginLeft:1, marginTop: 1}}>
          <Grid item xs={12} sx={{ marginBottom: 2 }}>
            { lease.tenants && lease.tenants.map((tenant: Person) => (
